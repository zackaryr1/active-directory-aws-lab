...
Ran Phase 2 of the script, which creates four Organizational Units (IT, HR, Finance, Operations) and bulk-provisions 110 domain user accounts with titles, departments, and enabled credentials.<br/>
...
DNS Manager on DC01 showing the ramcharam.local forward lookup zone with records for both machines registered correctly.<br/>
